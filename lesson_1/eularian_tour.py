...
def create_tour(nodes):
    ...
    # # % len(nodes) wraps the index back to the beginning of the list, 
    # # connecting the first to the last elements. 
    ...
    ''' zip and slicing solution '''
    # print nodes[1:] # index pos 1 until end of list
    # print nodes[:1] # index pos 0 until 1, which is the first element
    # ZIP: This function takes two equal-length collections, and merges them 
    # together in pairs.
    # print nodes[1:] + nodes[:1] # for the given input, this produces:
    # [21, 22, 23, 24, 25, 20]
    # which is then zipped with:
    # [20, 21, 22, 23, 24, 25]
    return zip(nodes, nodes[1:] + nodes[:1])
